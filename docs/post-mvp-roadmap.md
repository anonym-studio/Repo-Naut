...
**作成日**: 2026-05-15  
**最終更新**: 2026-05-16  
**対象バージョン**: v0.1.0 リリース後

v0.1.0（macOS ユニバーサル `.dmg`）を 2026-05-16 に GitHub Releases で公開。ランディングページも同日 Cloudflare Pages で公開済み。
...
| **v0.1.0 リリース** | macOS ユニバーサル `.dmg` / GitHub Releases / GitHub Actions CI | ✅ **2026-05-16 公開済み** |
| **ランディングページ** | Cloudflare Pages 公開 / カルーセル / 全セクション実装 | ✅ **2026-05-16 公開済み** |
